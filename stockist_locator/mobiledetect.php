...
/**
 * @file
 * Enables use of site-wide Stockist locator for mobile detect.
 * @author Rahul Sharma <rahulsh@hcl.in>
 */
/*
 * Detect mobile browser for Stockist locator map display
 * Implements locator_mobile_device_detect().
 */
function locator_mobile_device_detect($iphone=true,$ipad=true,$android=true,$opera=true,$blackberry=true,$palm=true,$windows=true,$mobileredirect=false,$desktopredirect=false){
	$mobile_browser = false;
	$user_agent = $_SERVER['HTTP_USER_AGENT'];
	$accept = $_SERVER['HTTP_ACCEPT'];
	switch(true){ 
		case (preg_match('/ipad/i',$user_agent));
		$mobile_browser = $ipad; $status = 'Apple iPad';
		...
		$mobile_browser = $palm; $status = 'Palm';
		...
		$mobile_browser = $windows; $status = 'Windows Smartphone';
